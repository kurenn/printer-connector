...
final class ConnectorConfigTests: XCTestCase {
    ...
    func testLoadCollectsRegisteredHostsFromBaseURL() {
        ...
        {"connector_id":"2","printers":[
          {"printer_id":1,"name":"K1","type":"klipper","base_url":"http://192.168.1.70:7125","ui_port":80},
          {"printer_id":2,"name":"viktor","base_url":"http://192.168.1.81:7125"},
          {"printer_id":3,"base_url":"http://192.168.1.87:7125"}
        ]}
        """)
        XCTAssertEqual(ConnectorConfig.load(path: path)?.registeredHosts,
                       ["192.168.1.70", "192.168.1.81", "192.168.1.87"])
    }
